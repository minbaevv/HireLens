    ...
    "ru": {
        ...
        "pricing": [
            ...
            {"name": "Starter", "price": "4900", "period": "месяц", "highlighted": True,
             "features": ["100 кандидатов/месяц", "3 вакансии", "Голосовые интервью", "Telegram бот", "CSV экспорт"]},
    ...
    "ky": {
        ...
        "pricing": [
            ...
            {"name": "Starter", "price": "4900", "period": "ай", "highlighted": True,
             "features": ["айына 100 талапкер", "3 вакансия", "Үндүк интервью", "Telegram бот", "CSV экспорт"]},
