...
TG_TEXTS: dict[str, dict[str, str]] = {
    ...
    "ask_phone": {
        ...
        "ky": "Жакшы, <b>{name}</b>! Эми <b>телефон номериңизди</b> калтырыңыз — сиз менен ошонун аркасы менен байланышабыз.\nТүймөнҮ басыңыз же номерди колуңуз менен жазыңыз:",
        "en": "Nice to meet you, <b>{name}</b>! Please share your <b>phone number</b> — we will use it to contact you.\nTap the button below or type the number:",
    },
    "btn_send_phone": {
        "ru": "\U0001F4F1 Отправить мой номер",
        "ky": "\U0001F4F1 Номеримди жөнөтүү",
        "en": "\U0001F4F1 Share my number",
    },
    "invalid_phone": {
        "ru": "Не похоже на номер телефона. Напишите в виде 0705123456 или +996705123456:",
        "ky": "Бул телефон номерине окшош емес. 0705123456 же +996705123456 түрүндө жазыңыз:",
        "en": "That does not look like a phone number. Please use the format 0705123456 or +996705123456:",
    },
    "ask_photo": {
        ...
        "ky": "Рахмат! Эми <b>сүрөтүңүздү</b> жөнөтүңүз — жүзүңүз анык көрүнгөн жаңы сүрөт болсо жакшы.\nКаалабасаңыз — «Өткөрүп жиберүү» түймөсүн басыңыз.",
        "en": "Thank you! Now please send your <b>photo</b> as an image — ideally a recent one where your face is clearly visible.\nIf you prefer not to, tap \"Skip\".",
    },
    "btn_skip": {
        "ru": "Пропустить",
        "ky": "Өткөрүп жиберүү",
    ...
    "ask_photo_again": {
        "ru": "Отправьте, пожалуйста, именно фото картинкой — или нажмите «Пропустить».",
        "ky": "Сураныч, сүрөттү сүрөт түрүндө жөнөтүңүз — же «Өткөрүп жиберүү» түймөсүн басыңыз.",
    ...
    "photo_error": {
        "ru": "Не удалось загрузить фото. Попробуйте ещё раз или нажмите «Пропустить».",
        "ky": "Сүрөттү жүктөө мүмкүн болгон жок. Кайра аракет кылыңыз же «Өткөрүп жиберүү» түймөсүн басыңыз.",
        "en": "Failed to upload the photo. Please try again or tap \"Skip\".",
    },
    "photo_not_expected": {
    ...
    "application_accepted": {
        "ru": "✅ Заявка принята! Теперь начнём AI-интервью.\nОтвечайте на вопросы честно — это поможет получить высокий балл. Удачи! 🚀",
        "ky": "✅ Арыз кабыл алынды! Эми AI-интервью башталат.\nСуроолорго чынчылдык менен жооп бериңиз — бул жогорку балл алууга жардам берет. Ийгилик! 🚀",
        "en": "✅ Application accepted! Let's start the AI interview.\nAnswer honestly — it will help you get a higher score. Good luck! 🚀",
    },
